      ...
      <div className="footer-container">
        ...
        <div className="footer-section footer-brand">
          <div className="footer-logo">
            ...
            <span className="footer-logo-text">RiderConnect</span>
          </div>
          <p className="footer-tagline">
            India's fastest-growing motorcycle community. Connect with riders, discover epic routes, 
            and share your passion for the open road.
          </p>
